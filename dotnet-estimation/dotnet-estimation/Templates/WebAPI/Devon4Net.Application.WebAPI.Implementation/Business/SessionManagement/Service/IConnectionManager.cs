...
namespace Devon4Net.Application.WebAPI.Implementation.Business.SessionManagement.Service
{
    public interface IConnectionManager
    {
        ...
        /// </summary>
        /// <returns>All websocket connections in open state</returns>
        ...
        /// </summary>
        /// <returns>All websocket connections in Closed or CloseReceived state</returns>
        ConcurrentDictionary<string, WebSocket> GetAllClosed();

        /// <summary>
        /// Get a list of all current open Websocket id's.
        /// </summary>
        /// <returns>A List of available sockets ready to send via websockets.</returns>
